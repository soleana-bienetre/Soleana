...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Le Soin Bio-Expert est un soin personnalisé, adapté aux besoins spécifiques de votre peau au moment de la séance. Il convient aussi bien aux femmes qu'aux hommes, et s'appuie sur les actifs bio Estime & Sens pour nourrir, apaiser ou rééquilibrer la peau selon son état du jour. Le Soin Human, quant à lui, est exclusivement réservé aux hommes : il utilise une gamme spécifiquement formulée pour la peau masculine, avec des textures, des senteurs et des produits adaptés — dont des produits dédiés à la barbe. Les deux soins sont distincts et sans notion de hiérarchie.",
  },
  {
